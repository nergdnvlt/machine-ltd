...
class UserEndpointTest(TestCase):
    ...
    def test_get_another_user_endpoint(self):
        ...
        self.assertEqual(user['device_number'], '7192710055')
        self.assertEqual(user['radius'], 5.0)
    ...
    def test_update_user_endpoint(self):
        self.client.post('/api/v1/users/', {'user': {'username': 'Thor', 'phone_number': '7195558888', 'device_number': '7194447777'}}, format='json')
        user_id = User.objects.last().id

        response = self.client.put(f'/api/v1/users/{user_id}', {'user': {'username': 'Thor', 'phone_number': '7195558888', 'device_number': '7194447777', 'radius': 10}}, format='json')
    ...
    def test_sad_path_put_user_endpoint(self):
        response = self.client.put('/api/v1/users/10001', {'user': {'username': 'Thor', 'phone_number': '7195558888', 'device_number': '7194447777', 'radius': 10}}, format='json')
    ...
    def test_sad_path_patch_user_endpoint(self):
        response = self.client.patch('/api/v1/users/10001', {'user': {'username': 'Thor', 'phone_number': '7195558888', 'device_number': '7194447777', 'radius': 10}}, format='json')
